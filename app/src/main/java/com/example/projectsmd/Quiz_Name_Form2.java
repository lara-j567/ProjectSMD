...
public class Quiz_Name_Form2 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_quiz_name_form2);
    }
}*/
package com.example.projectsmd;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_makeQuiz.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                insertData(name);
                Intent i=new Intent(Quiz_Name_Form2.this , Fill_in_the_blank_quiz.class);
